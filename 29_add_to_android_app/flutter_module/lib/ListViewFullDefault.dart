      ...
      case 2:
        return SizedBox(
          ...
          child:  ListView.separated(
            ...
            separatorBuilder: (BuildContext context, int index) => Divider(height:6.0,color: Colors.blue),  // 添加分割线
            itemBuilder: (BuildContext context, int index) {
              return ListTile(
                title:  Text("title $index"), // item 标题
                leading: Icon(Icons.keyboard), // item 前置图标
              ...
              return Column(
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Padding(
                        padding: const EdgeInsets.all(8.0),//通过 EdgeInsets 来设置 padding的值
                        child: Text('list item $index'),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),//通过 EdgeInsets 来设置 padding的值
                  ...
                  Divider(height:6.0,color: Colors.blue),
                  Column(
                    ...
                    children: <Widget>[
                     Container(
                      ...
                      child: Align(
                        alignment: Alignment.centerLeft,//通过 EdgeInsets 来设置 padding的值
                        child: Text('list item $index'),
                      ),
                     ),
                     Container(
